...
class Patient(db.Model):
    ...
    date_of_birth = db.Column(db.Date, nullable=False) #YMD format date_of_birth=date(2003,3,25)
...
class History(db.Model):
    ...
    def __init__(self, patient_id, condition, description, start_date, end_date):
